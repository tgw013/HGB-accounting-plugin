...
**Status:** `v2.1.0` auf `main`. 14 Skills + 14 Commands, 128 Konten gegen DATEV-PDFs 2025+2026 verifiziert, **DATEV-EXTF-Export deterministisch** (Python-Serializer mit PORTAL-verifizierter Feld-Inventar; identische Eingabe → byte-identische CSV via SHA-256, GoBD-relevant). Vorgänger-Tags: `v1.1.0`, `v2.0.0-alpha`, `v2.0.0`, `v2.0.1`.
